...
- `test_nonlinearities.ipynb`: notebook for nonlinear response visualization
- `output/`: generated audio examples 

The time domain processing library that has been used to generate the reverberated material is not yet publicly available.  